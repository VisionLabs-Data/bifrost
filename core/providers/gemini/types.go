...
// GetParameterMappings maps OpenAI-compatible parameter names to Gemini JSON paths.
func (r *GeminiGenerationRequest) GetParameterMappings() map[string]string {
...
func (r *GeminiBatchEmbeddingRequest) GetParameterMappings() map[string]string { return nil }
...
func (r *GeminiEmbeddingRequest) GetParameterMappings() map[string]string { return nil }
...
func (r *GeminiImagenRequest) GetParameterMappings() map[string]string { return nil }
...
func (r *GeminiVideoGenerationRequest) GetParameterMappings() map[string]string { return nil }
